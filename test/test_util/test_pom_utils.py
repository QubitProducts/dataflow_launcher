...
class TestPomUtils(TestCase):
    ...
    def test_get_jar_filename(self):
        self.assertEqual(get_jar_filename('target', 'test-project', '1.0.0', default_format),
                         'target/test-project-1.0.0.jar')

    def test_get_custom_jar_filename(self):
        self.assertEqual(get_jar_filename('root_project/target', 'test-project', '1.0.0', default_format),
