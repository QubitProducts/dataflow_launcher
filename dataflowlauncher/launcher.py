...
from dataflowlauncher.utils.git_utils import has_dirty_master
...
def main():
    ...
    if not args.ignore_git and has_dirty_master(getcwd()):
        print("GIT check failed: clean master or --ignore_git flag required")
        exit(1)
